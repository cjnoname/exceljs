...
const data_validations_1 = __importDefault(require("./data-validations"));
...
class Worksheet {
    ...
    get dimensions() {
        const dimensions = new range_1.default();
    ...
    getColumn(c) {
        ...
        if (typeof c === 'string') {
            ...
            colNum = col_cache_1.default.l2n(c);
        }
        else {
            colNum = c;
        }
    ...
    getRow(r) {
        ...
        if (!row) {
            row = this._rows[r - 1] = new row_1.default(this, r);
        }
        return row;
    }
    ...
    _mergeCellsInternal(dimensions, ignoreStyle) {
        ...
        under_dash_1.default.each(this._merges, (merge) => {
    ...
    get hasMerges() {
        ...
        return under_dash_1.default.some(this._merges, Boolean);
    }
    ...
    unMergeCells(...cells) {
        ...
        for (let i = dimensions.top; i <= dimensions.bottom; i++) {
            for (let j = dimensions.left; j <= dimensions.right; j++) {
                ...
                if (cell) {
                    if (cell.type === enums_1.default.ValueType.Merge) {
    ...
    fillFormula(range, formula, results, shareType = 'shared') {
        ...
        const masterAddress = col_cache_1.default.encodeAddress(top, left);
    ...
    addImage(imageId, range) {
        ...
        this._media.push(new image_1.default(this, model));
    }
    getImages() {
    ...
    // Tables
    addTable(model) {
        const table = new table_1.default(this, model);
...
Please leave feedback at https://github.com/exceljs/exceljs/discussions/2575`);
    ...
    get model() {
        ...
        // =================================================
        // columns
        model.cols = column_1.default.toModel(this.columns);
        // ==========================================================
        // Rows
        const rows = (model.rows = []);
        const dimensions = (model.dimensions = new range_1.default());
        this._rows.forEach(row => {
    ...
    _parseRows(model) {
        ...
        if (model.rows) {
            model.rows.forEach(rowModel => {
                const row = new row_1.default(this, rowModel.number);
    ...
    _parseMergeCells(model) {
        if (model.mergeCells) {
            under_dash_1.default.each(model.mergeCells, (merge) => {
    ...
    set model(value) {
        ...
        this._columns = column_1.default.fromModel(this, value.cols);
        this._parseRows(value);
        this._parseMergeCells(value);
        this.dataValidations = new data_validations_1.default(value.dataValidations);
        this.properties = value.properties;
        this.pageSetup = value.pageSetup;
        this.headerFooter = value.headerFooter;
        this.views = value.views;
        this.autoFilter = value.autoFilter;
        this._media = value.media.map(medium => new image_1.default(this, medium));
        this.sheetProtection = value.sheetProtection;
        this.tables = value.tables.reduce((tables, table) => {
            const t = new table_1.default(this, table);
            t.model = table;
            tables[table.name] = t;
            return tables;
        }, {});
