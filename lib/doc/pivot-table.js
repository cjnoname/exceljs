...
function validate(worksheet, model) {
    ...
    const isInHeaderNames = (0, utils_1.objectFromProps)(headerNames, true);
...
function makeCacheFields(worksheet, fieldNamesWithSharedItems) {
    ...
    const nameToHasSharedItems = (0, utils_1.objectFromProps)(fieldNamesWithSharedItems, true);
    const aggregate = (columnIndex) => {
        ...
        return (0, utils_1.toSortedArray)(columnValuesAsSet);
    };
    // make result
    const result = [];
