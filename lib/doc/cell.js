...
const shared_formula_1 = require("../utils/shared-formula");
// Cell requirements
...
class Cell {
    constructor(row, column, address) {
        ...
        this._row = row;
        this._column = column;
        col_cache_1.default.validateAddress(address);
    ...
    set note(note) {
        this._comment = new note_1.default(note);
    }
    get text() {
        return this._value.toString();
    }
    get html() {
        return under_dash_1.default.escapeHtml(this.text);
    }
    toString() {
        return this.text;
    }
    ...
    set model(value) {
        ...
        if (value.comment) {
            switch (value.comment.type) {
                case 'note':
                    this._comment = note_1.default.fromModel(value.comment);
                    break;
            }
        }
        if (value.style) {
...
Cell.Types = enums_1.default.ValueType;
// =============================================================================
...
class FormulaValue {
    ...
    get formulaType() {
        if (this.model.formula) {
            return enums_1.default.FormulaType.Master;
        }
        if (this.model.sharedFormula) {
            return enums_1.default.FormulaType.Shared;
        }
        return enums_1.default.FormulaType.None;
    }
    get result() {
    ...
    _getTranslatedFormula() {
        if (!this._translatedFormula && this.model.sharedFormula) {
            ...
            this._translatedFormula =
                master && (0, shared_formula_1.slideFormula)(master.formula, master.address, this.model.address);
        }
