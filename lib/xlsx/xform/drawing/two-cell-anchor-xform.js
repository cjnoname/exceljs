...
class TwoCellAnchorXform extends base_cell_anchor_xform_1.default {
    constructor() {
        super();
        this.map = {
            'xdr:from': new cell_position_xform_1.default({ tag: 'xdr:from' }),
            'xdr:to': new cell_position_xform_1.default({ tag: 'xdr:to' }),
...
exports.default = TwoCellAnchorXform;
