    ...
    textRotation(value) {
        switch (value) {
            case 'vertical':
                return value;
            default: {
                const numValue = utils_1.default.validInt(value);
...
const textRotationXform = {
    ...
    toModel(textRotation) {
        const tr = utils_1.default.validInt(textRotation);
        if (tr !== undefined) {
            if (tr === 255) {
                return 'vertical';
            }
...
class AlignmentXform extends base_xform_1.default {
    get tag() {
        return 'alignment';
    }
    ...
    parseOpen(node) {
        ...
        add(node.attributes.wrapText, 'wrapText', utils_1.default.parseBoolean(node.attributes.wrapText));
        add(node.attributes.shrinkToFit, 'shrinkToFit', utils_1.default.parseBoolean(node.attributes.shrinkToFit));
...
exports.default = AlignmentXform;
