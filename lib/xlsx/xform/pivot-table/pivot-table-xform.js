...
class PivotTableXform extends base_xform_1.default {
    constructor() {
        super();
        this.map = {};
    }
    ...
    render(xmlStream, model) {
        ...
        xmlStream.openNode(this.tag, Object.assign(Object.assign({}, PivotTableXform.PIVOT_TABLE_ATTRIBUTES), { 'xr:uid': '{267EE50F-B116-784D-8DC2-BA77DE3F4F4A}', name: 'PivotTable2', cacheId, applyNumberFormats: '0', applyBorderFormats: '0', applyFontFormats: '0', applyPatternFormats: '0', applyAlignmentFormats: '0', applyWidthHeightFormats: '1', dataCaption: 'Values', updatedVersion: '8', minRefreshableVersion: '3', useAutoFormatting: '1', itemPrintTitles: '1', createdVersion: '8', indent: '0', compact: '0', compactData: '0', multipleFieldFilters: '0' }));
...
exports.default = PivotTableXform;
