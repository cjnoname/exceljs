...
class PivotCacheRecordsXform extends base_xform_1.default {
    constructor() {
        super();
        this.map = {};
    }
    ...
    render(xmlStream, model) {
        ...
        xmlStream.openNode(this.tag, Object.assign(Object.assign({}, PivotCacheRecordsXform.PIVOT_CACHE_RECORDS_ATTRIBUTES), { count: sourceBodyRows.length }));
...
exports.default = PivotCacheRecordsXform;
