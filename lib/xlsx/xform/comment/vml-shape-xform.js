...
const vml_textbox_xform_1 = __importDefault(require("./vml-textbox-xform"));
const vml_client_data_xform_1 = __importDefault(require("./vml-client-data-xform"));
class VmlShapeXform extends base_xform_1.default {
    constructor() {
        super();
        this.map = {
            'v:textbox': new vml_textbox_xform_1.default(),
            'x:ClientData': new vml_client_data_xform_1.default(),
        };
    }
    get tag() {
        return 'v:shape';
