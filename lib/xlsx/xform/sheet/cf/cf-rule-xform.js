...
class CfRuleXform extends composite_xform_1.default {
    ...
    createNewModel({ attributes }) {
        return Object.assign(Object.assign({}, opType(attributes)), { dxfId: base_xform_1.default.toIntValue(attributes.dxfId), priority: base_xform_1.default.toIntValue(attributes.priority), timePeriod: attributes.timePeriod, percent: base_xform_1.default.toBoolValue(attributes.percent), bottom: base_xform_1.default.toBoolValue(attributes.bottom), rank: base_xform_1.default.toIntValue(attributes.rank), aboveAverage: base_xform_1.default.toBoolValue(attributes.aboveAverage) });
    }
