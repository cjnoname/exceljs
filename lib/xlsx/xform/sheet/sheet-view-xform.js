...
class SheetViewXform extends base_xform_1.default {
    get tag() {
        return 'sheetView';
    }
    prepare(model) {
    ...
    render(xmlStream, model) {
        ...
        switch (model.state) {
            case 'frozen':
                ...
                topLeftCell = model.topLeftCell || col_cache_1.default.getAddress(ySplit + 1, xSplit + 1).address;
                activePane =
...
exports.default = SheetViewXform;
