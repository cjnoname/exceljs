...
const theme1_js_1 = __importDefault(require("../../xlsx/xml/theme1.js"));
class WorkbookWriter {
    constructor(options = {}) {
        ...
        this.media = [];
        this.commentRefs = [];
        this.zip = (0, archiver_1.default)('zip', this.zipOptions);
        if (options.stream) {
    ...
    addThemes() {
        return new Promise(resolve => {
            this.zip.append(theme1_js_1.default, { name: 'xl/theme/theme1.xml' });
            resolve();
        });
    }
    addOfficeRels() {
