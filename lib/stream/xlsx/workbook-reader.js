...
class WorkbookReader extends events_1.EventEmitter {
    ...
    parse(input, options) {
        return __asyncGenerator(this, arguments, function* parse_1() {
            ...
            try {
                for (var _g = true, zip_1 = __asyncValues(zip), zip_1_1; zip_1_1 = yield __await(zip_1.next()), _a = zip_1_1.done, !_a; _g = true) {
                    _c = zip_1_1.value;
                    _g = false;
                    const entry = _c;
                    let match;
                    ...
                    switch (entry.path) {
                        ...
                        case 'xl/sharedStrings.xml':
                            try {
                                for (var _h = true, _j = (e_4 = void 0, __asyncValues(this._parseSharedStrings(entry))), _k; _k = yield __await(_j.next()), _d = _k.done, !_d; _h = true) {
                                    _f = _k.value;
                                    _h = false;
                                    const item = _f;
                        ...
                        default:
                            if (entry.path.match(/xl\/worksheets\/sheet\d+[.]xml/)) {
                                ...
                                if (this.sharedStrings && this.workbookRels) {
                                    yield __await(yield* __asyncDelegator(__asyncValues(this._parseWorksheet((0, iterate_stream_1.default)(entry), sheetNo))));
                                }
                                else {
                                ...
                                sheetNo = match[1];
                                yield __await(yield* __asyncDelegator(__asyncValues(this._parseHyperlinks((0, iterate_stream_1.default)(entry), sheetNo))));
                            }
                            break;
                    }
                    if (!entryConsumed) {
                ...
                try {
                    if (!_g && !_a && (_b = zip_1.return)) yield __await(_b.call(zip_1));
                }
    ...
    _parseRels(entry) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.workbookRels = yield xform.parseStream((0, iterate_stream_1.default)(entry));
        });
    }
    _parseWorkbook(entry) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.model = yield workbook.parseStream((0, iterate_stream_1.default)(entry));
    ...
    _parseSharedStrings(entry) {
        return __asyncGenerator(this, arguments, function* _parseSharedStrings_1() {
            ...
            let font = null;
            try {
                for (var _d = true, _e = __asyncValues((0, parse_sax_1.default)((0, iterate_stream_1.default)(entry))), _f; _f = yield __await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const events = _c;
    ...
    _parseStyles(entry) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.options.styles === 'cache') {
                this.styles = new styles_xform_1.default();
                yield this.styles.parseStream((0, iterate_stream_1.default)(entry));
            }
        });
    }
