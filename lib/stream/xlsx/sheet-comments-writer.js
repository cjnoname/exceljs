...
const comment_xform_1 = __importDefault(require("../../xlsx/xform/comment/comment-xform"));
const vml_shape_xform_1 = __importDefault(require("../../xlsx/xform/comment/vml-shape-xform"));
class SheetCommentsWriter {
    ...
    _writeComment(comment, index) {
        const commentXform = new comment_xform_1.default();
        const commentsXmlStream = new xml_stream_1.default();
        commentXform.render(commentsXmlStream, comment);
        this.commentsStream.write(commentsXmlStream.xml);
        const vmlShapeXform = new vml_shape_xform_1.default();
        const vmlXmlStream = new xml_stream_1.default();
...
exports.default = SheetCommentsWriter;
