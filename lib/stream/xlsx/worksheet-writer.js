...
const xform = {
    ...
    columns: new list_xform_1.default({ tag: 'cols', count: false, childXform: new col_xform_1.default() }),
    row: new row_xform_1.default(),
    hyperlinks: new list_xform_1.default({ tag: 'hyperlinks', count: false, childXform: new hyperlink_xform_1.default() }),
    sheetViews: new list_xform_1.default({ tag: 'sheetViews', count: false, childXform: new sheet_view_xform_1.default() }),
    ...
    _writeBackground() {
        if (this._background) {
            if (this._background.imageId !== undefined) {
                ...
                this._background = Object.assign(Object.assign({}, this._background), { rId: pictureId });
            }
