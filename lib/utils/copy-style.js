...
exports.copyStyle = void 0;
const oneDepthCopy = (obj, nestKeys) => (Object.assign(Object.assign({}, obj), nestKeys.reduce((memo, key) => {
    if (obj[key])
        memo[key] = Object.assign({}, obj[key]);
    return memo;
}, {})));
...
const copyStyle = (style) => {
    ...
    if (isEmptyObj(style))
        return {};
    const copied = Object.assign({}, style);
